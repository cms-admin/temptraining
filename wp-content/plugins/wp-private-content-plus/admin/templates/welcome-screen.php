<div id="wppcp-welcome-panel">
	...
	<div id="wppcp-welcome-video-panel">
		<div id="wppcp-welcome-video-panel-header">
			<?php _e('How to protect your first post?','wppcp'); ?>
		</div>
		<div id="wppcp-welcome-video-panel-player">
			<iframe width="560" height="315" src="https://www.youtube.com/embed/y2O9sRHNQC0?ecver=1" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>

	<div id="wppcp-welcome-guide-panel">
		<div id="wppcp-welcome-first-restriction">
			<a href="<?php echo admin_url('post-new.php'); ?>"><?php _e('Protect You\'r First Post'); ?></a>
		</div>
		<div id="wppcp-welcome-read-docs">
			<a href="http://www.wpexpertdeveloper.com/wp-private-content-plus/"><?php _e('Read Documentation'); ?></a>
		</div>
		...
		<div id="wppcp-welcome-features-list">
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/content-restrictions.png" />
				</div>
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/menu.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/widget.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/search.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/attachment.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/password.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/private_page.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class="wppcp-welcome-feature">
				<div class="wppcp-welcome-feature-left">
					<img src="<?php echo WPPCP_PLUGIN_URL; ?>images/docs/profile.png" />
				</div>
				<div class="wppcp-welcome-feature-right">
					<div class="wppcp-welcome-feature-header">
			...
			<div class='wppcp-welcome-all-features'>
				<a href="http://bit.ly/2v05Up1" target="_blank"><?php _e('View All Features','wppcp'); ?></a>
			</div>
		</div>
	</div>
	...
	<div id="wppcp-welcome-pro-info">
		<div id="wppcp-welcome-pro-info-left">
			...
			<div id="wppcp-pro-version-welcome-features">
				<?php $tick_url = WPPCP_PLUGIN_URL. 'images/tick.png';  ?>
                <ul>
		...
		<div id="wppcp-welcome-pro-info-right">
			...
			<a class="wppcp-upgrading-pro-button" style="margin:10px auto" href="http://bit.ly/2fGOsDf">
	...
	<div id="wppcp-welcome-pro-reviews">
		...
		<div class="wppcp-welcome-pro-review">
			<div class="wppcp-welcome-pro-review-image"><img src="<?php echo WPPCP_PLUGIN_URL. 'images/assets/chris.jpeg'; ?>" /></div>
		...
		<div class="wppcp-welcome-pro-review">
			<div class="wppcp-welcome-pro-review-image"><img src="<?php echo WPPCP_PLUGIN_URL. 'images/assets/kyle.png'; ?>" /></div>
			<div class="wppcp-welcome-pro-review-message">
